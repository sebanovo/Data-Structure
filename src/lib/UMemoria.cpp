...
int CSMemoria::new_espacio(string cadena) {
    ...
    // el delete espacio no elina el id pregutar si podemos eliminar el id de la memoria
    // if (hayUnIdRepetidoEnLaMemoria(cadena))
    //     throw std::runtime_error("Hay un id repetido en la memoria");
...
// busca si el id ya estaba repetido en la cadena
// bool CSMemoria::hayUnIdRepetidoEnLaMemoria(string cadena) {
//     set<string> idsUnicos;
//     stringstream ss(cadena);
//     string id;
