...
namespace UPolinomioSM {
    ...
    int PolinomioSM::coeficiente(int exp) {
        ...
        return dir == NULO ? mem->obtener_dato(dir, "->coef") : throw std::runtime_error("No existe este exponente");
    }
    ...
    int PolinomioSM::exponente(int nroTer) {
        ...
        return dir == NULO ? mem->obtener_dato(dir, "->exp") : throw std::runtime_error("No existe este exponente");
    }
