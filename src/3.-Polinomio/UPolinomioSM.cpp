...
namespace UPolinomioSM {
    ...
    void PolinomioSM::poner_termino(int coef, int exp) {
        ...
        if (existe == NULO) {  //
            ...
            mem->poner_dato(existe, _coef, mem->obtener_dato(existe, _coef) + coef);
        }
    }
    ...
    string PolinomioSM::mostrar() {
        ...
        while (x != NULO) {
            ...
            s += std::to_string(mem->obtener_dato(x, _coef)) + "x^" + std::to_string(mem->obtener_dato(x, _exp)) + "  ";
